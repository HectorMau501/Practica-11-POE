...
public class frmRegistrarPrestamo extends javax.swing.JFrame {
    ...
    {
        fondo = new ImagenFondo("src/Imagenes/daniel-zjV8ptYgcEo-unsplash.jpg");
    ...
    private void initComponents() {
        ...
        jtfDiasPrestamo.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jtfDiasPrestamo.setForeground(new java.awt.Color(0, 0, 0));

        jtfCantidadLibros.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jtfCantidadLibros.setForeground(new java.awt.Color(0, 0, 0));

        jtfFechaPrestamo.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jtfFechaPrestamo.setForeground(new java.awt.Color(0, 0, 0));

        jtfFechaDevuelto.setFont(new java.awt.Font("Dialog", 0, 14)); // NOI18N
        jtfFechaDevuelto.setForeground(new java.awt.Color(0, 0, 0));
